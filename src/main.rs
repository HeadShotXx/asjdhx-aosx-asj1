...
static SECRET_KEY: Lazy<Vec<u8>> = Lazy::new(|| {
    obfuscate_bytes!(&[
    0x90, 0x8b, 0x69, 0xc7, 0x19, 0x55, 0x44, 0x04, 0x49, 0x8c, 0xc6, 0xfe, 0xca, 0xf4, 0x25, 0x65, 
    0xc7, 0x93, 0x41, 0x08, 0xcf, 0x80, 0x6a, 0x27, 0x02, 0x48, 0x00, 0x0b, 0x10, 0x9b, 0x24, 0x51, 
    ])
});
